              ...
              const functors = [
                ...
                ({
                  ...
                  (function () {
                    ...
                    $h‍_once.AggregateError(AggregateError);
                    ...
                    $h‍_once.arrayFlatMap(arrayFlatMap);
                ...
                ({
                  ...
                  (function () {
                    ...
                    $h‍_imports([
                      [
                        '../make-lru-cachemap.js',
                        [
                          [
                            'makeLRUCacheMap',
                            [($h‍_a) => (makeLRUCacheMap = $h‍_a)],
                          ],
                        ],
                      ],
                      ['./internal-types.js', []],
                ...
                ({
                  ...
                  (function () {
                    ...
                    /** @type {GenericErrorConstructor[]} */ $h‍_once.uniqueGlobalPropertyNames(
                      uniqueGlobalPropertyNames
                    );
                    const NativeErrors = [
                      EvalError,
                    ...
                    const permitted = {
                      ...
                      '%AggregateErrorPrototype%':
                        NativeErrorPrototype('AggregateError'),
                      ...
                      '%Float16ArrayPrototype%':
                        TypedArrayPrototype('Float16Array'),
  ...
  `);
                ...
                ({
                  ...
                  (function () {
                    ...
                    $h‍_imports([
                      [
                        ...
                        [
                          ['WeakSet', [($h‍_a) => (WeakSet = $h‍_a)]],
                          ['arrayFilter', [($h‍_a) => (arrayFilter = $h‍_a)]],
                          ['arrayFlatMap', [($h‍_a) => (arrayFlatMap = $h‍_a)]],
                          ['arrayMap', [($h‍_a) => (arrayMap = $h‍_a)]],
                          ['arrayPop', [($h‍_a) => (arrayPop = $h‍_a)]],
                          ['arrayPush', [($h‍_a) => (arrayPush = $h‍_a)]],
                          [
                    ...
                    /** @type {readonly [ConsoleProps, LogSeverity | undefined][]} */ $h‍_once.consoleOtherMethods(
                      consoleOtherMethods
                    );
                    ...
                    /** @type {ErrorInfo} */ $h‍_once.pumpLogToConsole(
                      pumpLogToConsole
                    );
                    const ErrorInfo = {
                      NOTE: 'ERROR_NOTE:',
                     ...
                     * @param {LoggedErrorHandler} loggedErrorHandler
                     */
                    const defineCausalConsoleFromLogger = (
                      loggedErrorHandler
                    ) => {
                      /**
                      ...
                      const makeCausalConsoleFromLogger = (tlogger) => {
                        ...
                        if (baseConsole.groupEnd) {
                          baseConsole.groupEnd = makeNamed(
                            'groupEnd',
                            (...args) => {
                              arrayPop(indents);
                            }
                    ...
                    $h‍_once.defineCausalConsoleFromLogger(
      ...
      `
                ...
                ({
                  ...
                  (function () {
                      ...
                      [
                        ...
                        [
                          [
                            ...
                            [
                              ($h‍_a) =>
                                (defineCausalConsoleFromLogger = $h‍_a),
                            ],
                          ],
                        ],
                      ],
                     ...
                     */
                    const MAKE_CAUSAL_CONSOLE_FROM_LOGGER_KEY_FOR_SES_AVA =
                      symbolFor(
                        'MAKE_CAUSAL_CONSOLE_FROM_LOGGER_KEY_FOR_SES_AVA'
                      );
              ...
              functors[11]({
                ...
                onceVar: {
                  ...
                  initialGlobalPropertyNames:
                    cells[11].initialGlobalPropertyNames.set,
                  sharedGlobalPropertyNames:
                    cells[11].sharedGlobalPropertyNames.set,
                  uniqueGlobalPropertyNames:
                    cells[11].uniqueGlobalPropertyNames.set,
              ...
              functors[12]({
                ...
                onceVar: {
                  makeIntrinsicsCollector:
                    cells[12].makeIntrinsicsCollector.set,
              ...
              functors[22]({
                ...
                onceVar: {
                  makeFunctionConstructor:
                    cells[22].makeFunctionConstructor.set,
                },
                importMeta: {},
              });
              functors[23]({
                ...
                onceVar: {
                  setGlobalObjectSymbolUnscopables:
                    cells[23].setGlobalObjectSymbolUnscopables.set,
                  setGlobalObjectConstantProperties:
                    cells[23].setGlobalObjectConstantProperties.set,
                  setGlobalObjectMutableProperties:
                    cells[23].setGlobalObjectMutableProperties.set,
                  setGlobalObjectEvaluators:
                    cells[23].setGlobalObjectEvaluators.set,
                },
                importMeta: {},
              });
              functors[24]({
                ...
                onceVar: {
                  ...
                  strictScopeTerminatorHandler:
                    cells[24].strictScopeTerminatorHandler.set,
              ...
              functors[25]({
                ...
                onceVar: {
                  createSloppyGlobalsScopeTerminator:
                    cells[25].createSloppyGlobalsScopeTerminator.set,
                },
                importMeta: {},
              });
              functors[26]({
              ...
              functors[28]({
                ...
                onceVar: {
                  ...
                  rejectImportExpressions:
                    cells[28].rejectImportExpressions.set,
                  evadeImportExpressionTest:
                    cells[28].evadeImportExpressionTest.set,
                  rejectSomeDirectEvalExpressions:
                    cells[28].rejectSomeDirectEvalExpressions.set,
              ...
              functors[34]({
                ...
                onceVar: {
                  ...
                  defineCausalConsoleFromLogger:
                    cells[34].defineCausalConsoleFromLogger.set,
              ...
              functors[41]({
                ...
                onceVar: {
                  provideCompartmentEvaluator:
                    cells[41].provideCompartmentEvaluator.set,
              ...
              functors[42]({
                ...
                onceVar: {
                  makeThirdPartyModuleInstance:
                    cells[42].makeThirdPartyModuleInstance.set,
              ...
              functors[44]({
                ...
                onceVar: {
                  ...
                  makeCompartmentConstructor:
                    cells[44].makeCompartmentConstructor.set,
                },
                importMeta: {},
              });
              functors[45]({
            ...
            const {
              ...
              (function () {
                ...
                (function () {
                   ...
                   */
                  function generateScuttleOpts(
                    globalRef,
                    originalOpts = create(null)
                  ) {
                    const defaultOpts = {
                      enabled: true,
                      exceptions: [],
                    ...
                    const opts = assign(
                      ...
                      {
                        scuttlerFunc: (globalRef, scuttle) =>
                          scuttle(globalRef),
                      },
                      {
                        exceptions: (
